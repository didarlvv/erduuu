...
const translations = {
  ...
  tk: {
    ...
    "sidebar.externalOutgoing": "Çykyş daşky hatlar",
    "sidebar.externalIncoming": "Giriş daşky hatlar",
    "sidebar.internalOutgoing": "Çykyş içerki hatlar",
    "sidebar.internalIncoming": "Giriş içerki hatlar",
    "sidebar.logs": "Loglar",
