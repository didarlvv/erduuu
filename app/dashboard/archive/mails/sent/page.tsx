  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-semibold text-gray-800">
            {translate("mails.archivedSent", language)}
          </h1>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {translate("mails.manageArchivedSent", language)}
          </CardTitle>
          <CardDescription>
            {translate("mails.manageArchivedSentDescription", language)}
          </CardDescription>
        </CardHeader>
        <CardContent>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="sent">
                            {translate("mails.status.sent", language)}
                          </SelectItem>
                          <SelectItem value="delivered">
                            {translate("mails.status.delivered", language)}
                          </SelectItem>
