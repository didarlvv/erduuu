  ...
  const loadMails = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetchExternalMails({
        ...
        ...(["new", "replied", "progress", "answered"].includes(
          filters.status
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        ...
        {hasCreateAccess && (
          <Button
            onClick={() =>
              router.push("/dashboard/external-mail/outgoing/create")
            }
              ...
              <div className="flex-grow">
                <Input
                  placeholder={translate(
                    "outgoingMails.searchPlaceholder",
                    language
                  )}
                ...
                <CardContent className="pt-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2 col-span-full">
                      <label className="text-sm font-medium">
                        {translate("outgoingMails.dateRange", language)}
                      </label>
