...
import type { File, FileResponse } from "@/lib/types";
...
export default function FilesPage() {
  ...
  const loadFiles = useCallback(async () => {
    ...
    try {
      setIsLoading(true);
      const response: FileResponse = await fetchFiles({
        skip: currentPage,
        limit: filters.limit,
    ...
    <div className="p-6 space-y-6">
      <div className="flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-2xl font-semibold text-gray-800">
            {translate("files.title", language)}
          </h1>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {translate("files.manageDescription", language)}
          </CardDescription>
        </CardHeader>
        <CardContent>
                        ...
                        >
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="created_at">
                              {translate("files.creationDate", language)}
                            </SelectItem>
                            <SelectItem value="original_name">
                              {translate("files.originalName", language)}
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
